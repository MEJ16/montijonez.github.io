...
_.first = function(array, number) {
    ...
    const result = array.slice(0, number);
    return result;
...
_.last = function(array, number) {
    ...
    const result = array.slice(array.length - number);
    return result;
  }
...
_.map = function( collection, func) {
    ...
    // because Arrays and Objects loop differently
    if (Array.isArray(collection)) {
        
        // iterate
        for (var i = 0; i < collection.length; i++){
            // call the func, and save the returned value
