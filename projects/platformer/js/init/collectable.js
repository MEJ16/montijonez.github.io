(function (window) {
    ...
    collectable.init = function (game) {
        ...
        //collectable.create(type.db, 800, 100, 6, 0.7);
        //collectable.create(type.max, 150, 190, 6, 0.7);
        collectable.create(type.steve, 600, 20, 6, 0.7);
        //collectable.create(type.grace, 200, 170, 6, 0.7);
        //collectable.create(type.kennedi, 200, 170, 6, 0.7);
